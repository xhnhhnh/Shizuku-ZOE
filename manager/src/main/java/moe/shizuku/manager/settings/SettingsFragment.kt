...
class SettingsFragment : PreferenceFragmentCompat() {
    ...
    private lateinit var cardStylePreference: ListPreference
    private lateinit var enableAnimationsPreference: TwoStatePreference
    private lateinit var enableCardElevationPreference: TwoStatePreference
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        cardStylePreference = findPreference("card_style")!!
        enableAnimationsPreference = findPreference("enable_animations")!!
        enableCardElevationPreference = findPreference("enable_card_elevation")!!
        ...
        cardStylePreference.onPreferenceChangeListener =
            Preference.OnPreferenceChangeListener { _, _ ->
                activity?.recreate()
                true
            }

        enableAnimationsPreference.onPreferenceChangeListener =
            Preference.OnPreferenceChangeListener { _, _ ->
                true
            }

        enableCardElevationPreference.onPreferenceChangeListener =
            Preference.OnPreferenceChangeListener { _, _ ->
                activity?.recreate()
                true
            }
